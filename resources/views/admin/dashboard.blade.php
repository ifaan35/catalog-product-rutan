...
<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="header-gradient mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right hidden md:block">
                    ...
                    <p class="text-3xl font-bold text-yellow-300">RUTAN</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="stat-card bg-white rounded-2xl p-8 shadow-xl border-t-4" style="border-color: #F3C32A;">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-600 text-sm font-semibold mb-2">⏳ Pesanan Menunggu</p>
                        <p class="stat-number" style="color: #F3C32A;">{{ $pendingOrders }}</p>
                    ...
                    <div class="icon-wrapper p-4 rounded-full" style="background: linear-gradient(135deg, #FFF7E6 0%, #FFE8B6 100%);">
                        <svg class="w-8 h-8" style="color: #F3C32A;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="stat-card bg-white rounded-2xl p-8 shadow-xl border-t-4" style="border-color: #10B981;">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="stat-number text-green-600">Rp {{ number_format($totalSales, 0, ',', '.') }}</p>
            ...
            <!-- Card 3: Total Produk -->
            <div class="stat-card bg-white rounded-2xl p-8 shadow-xl border-t-4" style="border-color: #3B82F6;">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-600 text-sm font-semibold mb-2">📦 Total Produk</p>
                        <p class="stat-number text-blue-600">{{ $totalProducts }}</p>
                        <p class="text-gray-500 text-xs mt-2">Produk aktif</p>
                    </div>
                    <div class="icon-wrapper p-4 rounded-full" style="background: linear-gradient(135deg, #EFF6FF 0%, #DBEAFE 100%);">
            ...
            <div class="stat-card bg-white rounded-2xl p-8 shadow-xl border-t-4" style="border-color: #8B5CF6;">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-600 text-sm font-semibold mb-2">📋 Orders Hari Ini</p>
                        <p class="stat-number text-purple-600">{{ \App\Models\Order::whereDate('created_at', today())->count() }}</p>
                        <p class="text-gray-500 text-xs mt-2">Pesanan baru hari ini</p>
                    </div>
                    <div class="icon-wrapper p-4 rounded-full" style="background: linear-gradient(135deg, #F3E8FF 0%, #E9D5FF 100%);">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="action-card bg-white rounded-2xl p-8 text-center border-l-4" style="border-left-color: #F3C32A; position: relative; overflow: hidden;">
                <div style="position: absolute; top: -40px; right: -40px; width: 120px; height: 120px; background: linear-gradient(135deg, #F3C32A10 0%, #F3C32A20 100%); border-radius: 50%;"></div>
                <div class="relative z-10">
                    <div class="p-4 rounded-full inline-flex mb-4" style="background: linear-gradient(135deg, #F3C32A, #ECBF62);">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="inline-block px-6 py-3 rounded-lg font-semibold transition duration-300 transform hover:scale-105" style="background-color: #F3C32A; color: #072138;">
                        Manajemen Produk →
                    </a>
                </div>
            </div>
            ...
            <!-- Card 3: Laporan -->
            <div class="action-card bg-white rounded-2xl p-8 text-center border-l-4" style="border-left-color: #3B82F6; position: relative; overflow: hidden;">
                <div style="position: absolute; top: -40px; right: -40px; width: 120px; height: 120px; background: linear-gradient(135deg, #3B82F610 0%, #3B82F620 100%); border-radius: 50%;"></div>
                <div class="relative z-10">
                    <div class="p-4 rounded-full inline-flex mb-4" style="background: linear-gradient(135deg, #3B82F6, #1F70F0);">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button class="inline-block px-6 py-3 rounded-lg font-semibold text-white transition duration-300 transform hover:scale-105 cursor-not-allowed opacity-75" style="background: linear-gradient(135deg, #3B82F6, #1F70F0);">
                        ⏱️ Segera Hadir
                    </button>
                </div>
            </div>
        ...
        <!-- Pesanan Terbaru -->
        <div class="recent-orders-container bg-white shadow-xl rounded-2xl overflow-hidden border-t-4" style="border-color: #F3C32A;">
            <div class="px-8 py-6 border-b border-gray-200" style="background: linear-gradient(135deg, rgba(7, 33, 60, 0.03) 0%, rgba(243, 195, 42, 0.03) 100%);">
                <div class="flex items-center justify-between">
                    <div>
                    ...
                    <a href="{{ route('admin.orders.index') }}" class="inline-flex items-center px-6 py-3 text-sm font-semibold rounded-lg transition duration-300 transform hover:scale-105" style="background-color: #F3C32A; color: #072138;">
                        Lihat Semua Pesanan
